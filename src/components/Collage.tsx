      ...
      <Container>
        <div className="mx-auto max-w-7xl relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-4xl sm:text-5xl font-bold text-blue-700 mb-4">
              Redefine Possible: El Impacto que Creamos Juntos
            </h2>
            <p className="text-xl text-slate-700 max-w-3xl mx-auto leading-relaxed">
              <span className="block mt-2 font-semibold text-slate-700">Más que un evento: una comunidad de tecnología que valora y conmemora el Día Internacional de la Mujer.</span>
            </p>
          </div>
